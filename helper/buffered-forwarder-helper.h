...
#ifndef BUFFERED_FORWARDER_HELPER_H
#define BUFFERED_FORWARDER_HELPER_H
 ...
 */
class BufferedForwarderHelper
{
  public:
    BufferedForwarderHelper();  //!< Default constructor
    ~BufferedForwarderHelper(); //!< Destructor
...
#endif /* BUFFERED_FORWARDER_HELPER_H */
